...
%             obj.wd_res_fig.YLim = [obj.dt_E_min-1 obj.dt_E_max+1];
        ...
        function obj = loadData(obj, data)
            obj.dt_E_data             = data;
            obj.dt_E_data(:,1)        = obj.dt_E_data(:,1);        % q ��λ����
            % obj.dt_E_data(:,2)        = log(obj.dt_E_data(:,2)); % ln ����
...
%             obj.wd_res_fig.YGrid = 'on';
        ...
        % Distribution fitting mode ��ȡ��ϳ���ǰ����
        ...
        % Distribution fitting mode ��ͣ�Զ���ϳ���
