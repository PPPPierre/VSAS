function settingsButtonCallback(~, ~)
    ...
    setting_panels_title     = {'Variable Ranges', 'Model Settings', 'Bayesian Optimization', 'Grid Search', 'Program Parameters'};
    setting_panels_title_tag = {'set_vr','set_model', 'set_bo', 'set_gs', 'set_par'};
   ...
   %% 'Variable Ranges' penel labels
    ...
    for i = 1:size(var_names, 2)
        ...
        position_connect    = [165 y_pos+5, 50, 20];
        position_text_min   = [110, y_pos, 50, 20];
        position_text_max   = [200, y_pos, 50, 20];
