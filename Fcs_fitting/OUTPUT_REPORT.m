function User_report = OUTPUT_REPORT(Best_No, XB, MSE, Chi2, CorM, Max_Patch, P_Value, INFO)
...
%     end
    ...
    ColumnNames  = ['No' INFO.VarNames 'MSE' 'Chi2' 'CorMap' 'MaxPatch' 'PValue'];
    report_array = [idx_array XB_array MSE(3,:)' Chi2(3,:)' CorM(3,:)' Max_Patch' P_Value'];
